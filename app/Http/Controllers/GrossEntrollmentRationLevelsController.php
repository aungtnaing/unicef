...
class GrossEntrollmentRationLevelsController extends Controller
{
	...
	public function search()
	{
		...
		$total_populations=DB::select(DB::raw("SELECT SUM(age5_9boy+age5_9girl) AS total5_9,SUM(age10_13boy+age10_13girl) AS total10_13,SUM(age14_15boy+age14_15girl) AS total14_15 FROM population WHERE (townshipid ='".$town."' OR ''='".$town."') AND (academic_year='".$year."' OR ''='".$year."')"));
