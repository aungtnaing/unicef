...
class CombinedEnrollmentRatioController extends \BaseController
{
	public function create()
	{
		return View::make('gross.combined_enrollment_ratio_levels');
	}
	...
	public function search()
	{
		...
		return View::make('gross.combined_enrollment_ratio_levels',compact('region'));
