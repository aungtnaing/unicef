...
class PublicTeacherRatioController extends \BaseController
{
	public function create()
	{
		return View::make('teacher_ratio.public_teacher_ratio');
	}
	...
	public function search()
	{
		...
		return View::make('teacher_ratio.public_teacher_ratio',compact('region'));
