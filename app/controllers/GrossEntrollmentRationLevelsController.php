...
class GrossEntrollmentRationLevelsController extends \BaseController
{
	public function create()
	{
		return View::make('gross.gross_enrollment_ratio_levels');
	}
	...
	public function search()
	{
		...
		return View::make('gross.gross_enrollment_ratio_levels',compact('region','total_intake_pri','total_populations_pri','total_intake_mid','total_populations_mid','total_intake_high','total_populations_high'));

		} catch (Exception $e) {
			$record="<h4>Please Check in Searching!</h4>";
			return View::make('gross.gross_enrollment_ratio_levels',compact('region','record'));
		}
