...
<header>
    <div class="header-content">
        <div class="header-content-inner">
            <h1>SOMETIMES YOU WIN SOMETIMES YOU LEARN</h1>
            <hr>
...
<section style="background-color:lightcyan;" id="login">
    <div class="container">
        <div class="row">
            <div class="col-lg-8 col-lg-offset-2 text-center">
                <h2 class="section-heading">Login for Township Education Management System</h2>
                <hr class="light">
